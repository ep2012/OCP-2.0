...
namespace OCP_2._0
{
    public class TypesofAgreement : ObservableCollection<string>
    {
        ...
        {
            String titleSQL = "SELECT [TYPE_OF_AGREEMENT] FROM [REVINT].[dbo].[OCP_Contracts] WHERE NOT [TYPE_OF_AGREEMENT] IS NULL GROUP BY [TYPE_OF_AGREEMENT]";
    ...
    public class Statuses : ObservableCollection<string>
    {
        ...
        public Statuses()
        {
            String titleSQL = "SELECT [STATUS] FROM [REVINT].[dbo].[OCP_Contracts] WHERE NOT [STATUS] IS NULL GROUP BY [STATUS]";
    ...
    public class UIDepartments : ObservableCollection<string>
    {
        ...
        {
            String titleSQL = "SELECT [UI_DEPARTMENT] FROM [REVINT].[dbo].[OCP_Contracts] WHERE NOT [UI_DEPARTMENT] IS NULL GROUP BY [UI_DEPARTMENT]";
    ...
    public class Clients : ObservableCollection <string>
    {
        ...
        List<object> titleIDs = new List<object>();
        String titleSQL = "SELECT [CLIENT] FROM [REVINT].[dbo].[OCP_Contracts] WHERE NOT [CLIENT] IS NULL GROUP BY [CLIENT]";
        public Clients()
        {

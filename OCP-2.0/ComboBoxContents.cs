...
namespace OCP_2._0
{
    public class TypesofAgreement : ObservableCollection<string>
    {
        ...
        {
            String titleSQL = "SELECT TYPE_OF_AGREEMENT FROM [REVINT].[dbo].[OCP_TypesOfAgreement]";
    ...
    public class Statuses : ObservableCollection<string>
    {
        ...
        public Statuses()
        {
            String titleSQL = "SELECT STATUS FROM [REVINT].[dbo].[OCP_Statuses]";
    ...
    public class UIDepartments : ObservableCollection<string>
    {
        ...
        {
            String titleSQL = "SELECT UI_DEPARTMENT FROM [REVINT].[dbo].[OCP_UIDepartments]";
